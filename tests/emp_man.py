    ...
    def take_a_holiday(self, payout: bool) -> None:
        ...
        if payout:
            ...
            try:
                ...
                logging.info(f"Paying out a holiday. Holidays left: {self.vacation_days}")
            except Exception:
            ...
            logging.info("Have fun on your holiday. Don't forget to check your emails!")
...
def main() -> None:
    ...
    logging.info(company.find_vice_presidents())
    logging.info(company.find_managers())
    logging.info(company.find_interns())
